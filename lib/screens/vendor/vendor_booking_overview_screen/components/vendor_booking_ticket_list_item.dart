...
class VendorBookingTicketListItem extends StatelessWidget {
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                _getCategoryAndSubcategory(context),
                SizedBox(height: Dimensions.getScaledSize(5.0)),
                _getProductTextForTicket(ticket!, context),
  ...
  _getCategoryAndSubcategory(BuildContext context) {
  ...
  Widget _getProductTextForTicket(
      BookingModel.BookingTicket ticket, BuildContext context) {
    var bookingProduct = _getProductById(ticket.productId!);
